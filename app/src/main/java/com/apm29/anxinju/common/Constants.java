package com.apm29.anxinju.common;

public class Constants {

    public static final String APP_ID = "HsLLQeQJ2jZzRahZstLYnnSk3KBy9djmTajze47oguqh";
    public static final String SDK_KEY = "8nNWi6advDQ3taYUA7KkfRDEUNp73dnpZedYpy4gdWRR";
