...
import com.apm29.anxinju.MainActivity
import com.apm29.anxinju.R
...
//        }
    ...
    private fun startSelfWithNotification() {
        ...
        val builder = Notification.Builder(this)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(this.resources, R.mipmap.ic_launcher_round)) // 设置下拉列表中的图标(大图标)
                .setSmallIcon(R.mipmap.ic_launcher_round) // 设// 下文内容
        ...
        thread {
            try {
                ...
                while (line != null) {
                    ...
                    when {
                        line?.contains("FaceAttrPreviewActivity")  == true -> {
